...
| 27 | R-4 | Build relay.sh wrapper: JMAP auth bridge + session bootstrap (Basic auth, no OAuth) | relay/ | R-3 | pending |
...
- R-4: `tasks/active/r-4-jmap-auth-session-bootstrap.md`
