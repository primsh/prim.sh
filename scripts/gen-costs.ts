...
function renderMarkdown(): string {
	...
	lines.push("");
	lines.push("Zero markup. One mill ($0.001) floor. Infinite primitives.");
...
<meta name="description" content="Zero markup. One mill ($0.001) floor. Infinite primitives. Full cost breakdown for every prim.sh primitive.">
