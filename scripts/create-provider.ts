...
import { genVendorTs, parseProviderInterface, toPascalCase } from "./lib/provider-gen.ts";
...
const matchingProvider = providers.find((p) => p.name.toLowerCase() === vendorName.toLowerCase());
