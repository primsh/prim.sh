...
import type { GenerateRequest, DescribeRequest, UpscaleRequest, GenerateResponse, DescribeResponse, UpscaleResponse, ModelsResponse } from "./api.ts";
...
): Promise<ServiceResult<GenerateResponse>> {
...
): Promise<ServiceResult<DescribeResponse>> {
...
export async function upscale(
  body: UpscaleRequest,
): Promise<ServiceResult<UpscaleResponse>> {
