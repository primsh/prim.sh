#!/bin/sh
# Install imagine.sh — prim.sh
# Usage: curl -fsSL https://imagine.prim.sh/install.sh | sh
set -eu
...
echo ""
echo "  imagine.sh installed. Your agent can now use imagine tools."
