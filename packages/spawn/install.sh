#!/bin/sh
# Install spawn.sh — prim.sh
# Usage: curl -fsSL https://spawn.prim.sh/install.sh | sh
set -eu
...
echo ""
echo "  spawn.sh installed. Your agent can now use spawn tools."
