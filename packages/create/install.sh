#!/bin/sh
# Install create.sh — prim.sh
# Usage: curl -fsSL https://create.prim.sh/install.sh | sh
set -eu
...
echo ""
echo "  create.sh installed. Your agent can now use create tools."
