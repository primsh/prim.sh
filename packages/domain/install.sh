#!/bin/sh
# Install domain.sh — prim.sh
# Usage: curl -fsSL https://domain.prim.sh/install.sh | sh
set -eu
...
echo ""
echo "  domain.sh installed. Your agent can now use domain tools."
