#!/bin/sh
# Install email.sh — prim.sh
# Usage: curl -fsSL https://email.prim.sh/install.sh | sh
set -eu
...
echo ""
echo "  email.sh installed. Your agent can now use email tools."
