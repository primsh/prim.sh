...
# Source: packages/gate/prim.yaml
# Regenerate: pnpm gen:install

# Install gate.sh — prim.sh
# Usage: curl -fsSL https://gate.prim.sh/install.sh | sh
set -eu
...
echo ""
echo "  gate.sh installed. Your agent can now use gate tools."
