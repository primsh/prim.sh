#!/bin/sh
# Install infer.sh — prim.sh
# Usage: curl -fsSL https://infer.prim.sh/install.sh | sh
set -eu
...
echo ""
echo "  infer.sh installed. Your agent can now use infer tools."
