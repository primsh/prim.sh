#!/bin/sh
# Install token.sh — prim.sh
# Usage: curl -fsSL https://token.prim.sh/install.sh | sh
set -eu
...
echo ""
echo "  token.sh installed. Your agent can now use token tools."
