...
export const emailTools: Tool[] = [
  ...
  },
  {
    ...
    description:
      "Send email from a mailbox. Requires to, subject, and body or html. | Price: $0.01",
    inputSchema: {
      type: "object",
      properties: {
        id: {
  ...
  },
  {
    ...
    description:
      "Register a webhook URL for message.received events. Optional secret for HMAC signing. | Price: $0.01",
    inputSchema: {
      type: "object",
      properties: {
        id: {
  ...
  },
  {
    ...
    description:
      "Verify DNS records. On success: status → verified, dkim_records returned. | Price: $0.01",
    inputSchema: {
      type: "object",
      properties: {
        id: {
