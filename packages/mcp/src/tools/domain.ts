...
export const domainTools: Tool[] = [
  ...
  },
  {
    ...
    description:
      "Full post-registration pipeline status (ns_propagated, zone_active, all_ready) | Price: $0.001",
    inputSchema: {
      type: "object",
      properties: {
        domain: {
  ...
  },
  {
    ...
    description:
      "Create a Cloudflare DNS zone. Returns nameservers to set at your registrar. | Price: $0.001",
    inputSchema: {
      type: "object",
      properties: {
        domain: {
