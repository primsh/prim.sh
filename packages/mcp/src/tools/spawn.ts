...
export const spawnTools: Tool[] = [
  ...
  },
  {
    ...
    description:
      "Provision a new VPS. Returns immediately with status 'initializing'. | Price: $0.01",
    inputSchema: {
      type: "object",
      properties: {
        name: {
  ...
  },
  {
    ...
    description:
      "Get full details for a single server. Poll this until status='running'. | Price: $0.001",
    inputSchema: {
      type: "object",
      properties: {
        id: {
  ...
  },
  {
    ...
    description:
      "Destroy a server and release its resources. Unused deposit is refunded. | Price: $0.005",
    inputSchema: {
      type: "object",
      properties: {
        id: {
  ...
  },
  {
    ...
    description:
      "Change server type (CPU/RAM). Server must be stopped first. Deposit adjusted. | Price: $0.01",
    inputSchema: {
      type: "object",
      properties: {
        id: {
  ...
  },
  {
    ...
    description:
      "Reinstall from a fresh OS image. All data on server is destroyed. | Price: $0.005",
    inputSchema: {
      type: "object",
      properties: {
        id: {
  ...
  },
  {
    ...
    description:
      "Register a public SSH key. Returned ID can be used in ssh_keys when creating a server. | Price: $0.001",
    inputSchema: {
      type: "object",
      properties: {
        name: {
  ...
  },
  {
    ...
    description:
      "Remove an SSH key. Keys in use by active servers remain until server is rebuilt. | Price: $0.001",
    inputSchema: {
      type: "object",
      properties: {
        id: {
