...
# Source: packages/faucet/prim.yaml
# Regenerate: pnpm gen:install

# Install faucet.sh — prim.sh
# Usage: curl -fsSL https://faucet.prim.sh/install.sh | sh
set -eu
...
echo ""
echo "  faucet.sh installed. Your agent can now use faucet tools."
