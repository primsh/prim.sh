#!/bin/sh
# Install track.sh — prim.sh
# Usage: curl -fsSL https://track.prim.sh/install.sh | sh
set -eu
...
echo ""
echo "  track.sh installed. Your agent can now use track tools."
