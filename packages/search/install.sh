...
# Source: packages/search/prim.yaml
# Regenerate: pnpm gen:install

# Install search.sh — prim.sh
# Usage: curl -fsSL https://search.prim.sh/install.sh | sh
set -eu
...
echo ""
echo "  search.sh installed. Your agent can now use search tools."
